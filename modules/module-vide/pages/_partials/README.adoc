...
:_public_repo_url: https://github.com/decidim/docs-authoring-guide

// MANDATORY. Title of the document. In web format, It appears as a heading of
// level 1. In PDF format, it appears in a title page.
:doctitle: Documentation Authoring and Publishing Guide

// OPTIONAL. Subtitle of the document.
:_subtitle: How to create, publish, maintain and contribute to Decidim documents
...
:_summary: This document explains the methodology and tools Decidim has put into effect to handle the documentation for the project. It is meant to be read not only by Decidim Team members, but also by other people willing to contribute to any Decidim document.
//
